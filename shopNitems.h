...
namespace shopNitems {
	...
	void CheckItem() {
		...
		for (int i = 0; i < 6; i++)
		{
			...
			{
				systems::gotoxy(1, 7 + attemptsToCatch);
				std::cout << Color::FG_GREY << "Dao." << Color::FG_DEFAULT;
				systems::gotoxy(1, 8 + attemptsToCatch);
				std::cout << Color::FG_RED << "dmg: " << ShopItems[0].damage << Color::FG_DEFAULT;
				systems::gotoxy(10, 8 + attemptsToCatch);
				std::cout << Color::FG_BRCYAN << "lv: " << ShopItems[0].LvlToEqp << Color::FG_DEFAULT;
				systems::gotoxy(17, 8 + attemptsToCatch);
				std::cout << Color::FG_GREEN << "cost: " << ShopItems[0].cost << Color::FG_DEFAULT;
				systems::gotoxy(1, 9 + attemptsToCatch);
				std::cout << "-----------------------------";
				attemptsToCatch += 3;
			}
			...
			{
				systems::gotoxy(1, 7 + attemptsToCatch);
				std::cout << Color::FG_GREY << "Quelling Blade." << Color::FG_DEFAULT;
				systems::gotoxy(1, 8 + attemptsToCatch);
				std::cout << Color::FG_RED << "dmg: " << ShopItems[1].damage << Color::FG_DEFAULT;
				systems::gotoxy(10, 8 + attemptsToCatch);
				std::cout << Color::FG_BRCYAN << "lv: " << ShopItems[1].LvlToEqp << Color::FG_DEFAULT;
				systems::gotoxy(17, 8 + attemptsToCatch);
				std::cout << Color::FG_GREEN << "cost: " << ShopItems[1].cost << Color::FG_DEFAULT;
				systems::gotoxy(1, 9 + attemptsToCatch);
				std::cout << "-----------------------------";
				attemptsToCatch += 3;
			}
			...
			{
				systems::gotoxy(1, 7 + attemptsToCatch);
				std::cout << Color::FG_GREY << "Ogre Axe." << Color::FG_DEFAULT;
				systems::gotoxy(1, 8 + attemptsToCatch);
				std::cout << Color::FG_RED << "dmg: " << ShopItems[2].damage << Color::FG_DEFAULT;
				systems::gotoxy(10, 8 + attemptsToCatch);
				std::cout << Color::FG_BRCYAN << "lv: " << ShopItems[2].LvlToEqp << Color::FG_DEFAULT;
				systems::gotoxy(17, 8 + attemptsToCatch);
				std::cout << Color::FG_GREEN << "cost: " << ShopItems[2].cost << Color::FG_DEFAULT;
				systems::gotoxy(1, 9 + attemptsToCatch);
				std::cout << "-----------------------------";
				attemptsToCatch += 3;
			}
			...
			{
				systems::gotoxy(1, 7 + attemptsToCatch);
				std::cout << Color::FG_GREY << "Katana." << Color::FG_DEFAULT;
				systems::gotoxy(1, 8 + attemptsToCatch);
				std::cout << Color::FG_RED << "dmg: " << ShopItems[3].damage << Color::FG_DEFAULT;
				systems::gotoxy(10, 8 + attemptsToCatch);
				std::cout << Color::FG_BRCYAN << "lv: " << ShopItems[3].LvlToEqp << Color::FG_DEFAULT;
				systems::gotoxy(17, 8 + attemptsToCatch);
				std::cout << Color::FG_GREEN << "cost: " << ShopItems[3].cost << Color::FG_DEFAULT;
				systems::gotoxy(1, 9 + attemptsToCatch);
				std::cout << "-----------------------------";
				attemptsToCatch += 3;
			}
	...
	{ //int map[35][93]
		...
		while (1) //infinite loop. (this loop will not break that's why we need an exit function).
		{
			...
			for (int i = 0; i < ShopItemsCount; i++) // Draw the menu.
			{
				...
				systems::gotoxy(40, 8 + i + ItemsCount);
				std::cout << ShopMenuItemsSpecs(false, true, false)[i] << std::endl;
				systems::gotoxy(45, 8 + i + ItemsCount);
				std::cout << ShopMenuItemsSpecs(true, false, false)[i] << std::endl;
				//systems::gotoxy(40, 7 + i + ItemsCount);
				//std::cout << ShopMenuItemsSpecs(false, false, true)[i] << endl;
