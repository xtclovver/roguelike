...
**_0.3.7_**
- "Visual Studio": в Header Files были добавлены все .h
- Баг в отображении оружия в левом меню исправлен
- (BETA) Магазин был доработан
- Добавлен debug и release версия
- В debug версии можно нажимать комбинации для откладки, токого нету в release версии
